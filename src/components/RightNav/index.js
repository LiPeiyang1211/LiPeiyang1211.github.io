...
class RightNav extends React.Component {
    state={
        taglist:[],
        sysTime: TimesFun('2022-7-1 22:00:00')
    }
    componentWillMount() {
        const {issues} = this.props;
        this.noRepeat(issues);
        setInterval(() => {
            let sysTime = TimesFun('2022-7-1 22:00:00')
            this.setState({
                sysTime
            })
        }, 1000)
    ...
    render() {
        ...
        return (
            <Row>
                <Card bordered={false} hoverable={true} className="card" cover={<img src={require('../../img/headbg.jpg')} />}>
                    ...
                    <Meta
                        title={
                            <div>
                                <span className="card-title">李佩洋</span>
                            </div>
                        }
                        description={
                            <div>
                                ...
                                <p className="abstract">1.<a target="_blank" href="https://gitee.com/lpy1211/back-stage">后台管理系统(Vue)</a></p>
                                <p className="abstract">2.<a target="_blank" href="https://gitee.com/lpy1211/take-out-food">外卖平台(Vue)</a></p>
                            </div>
                        }
                    />
                </Card>
